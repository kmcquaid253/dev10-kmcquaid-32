...
- Add your code to the project proREADvided. Be sure to use sensible class names, method names, and packages.
...
4. Play a full game.
    - Repeat until the game is over:
        ...
        5. If steone is not `null`, the player must be random. Use the stone in the step below.
